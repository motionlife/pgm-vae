...
baseline = {
    'nltcs': {'vars': 16, 'train': 16181, 'valid': 2157, 'test': 3236, 'pll': 4.98},
    'msnbc': {'vars': 17, 'train': 291326, 'valid': 38843, 'test': 58265, 'pll': 6.08},
    'kdd': {'vars': 64, 'train': 180092, 'valid': 19907, 'test': 34955, 'pll': 2.07},
    'plants': {'vars': 69, 'train': 17412, 'valid': 2321, 'test': 3482, 'pll': 10.21},
    'audio': {'vars': 100, 'train': 15000, 'valid': 2000, 'test': 3000, 'pll': 37.03},
    'jester': {'vars': 100, 'train': 9000, 'valid': 1000, 'test': 4116, 'pll': 49.75},
    'netflix': {'vars': 100, 'train': 15000, 'valid': 2000, 'test': 3000, 'pll': 52.67},
    'accidents': {'vars': 111, 'train': 12758, 'valid': 1700, 'test': 2551, 'pll': 12.69},
    'retail': {'vars': 135, 'train': 22041, 'valid': 2938, 'test': 4408, 'pll': 10.39},
    'pumsb_star': {'vars': 163, 'train': 12262, 'valid': 1635, 'test': 2452, 'pll': 9.79},
    'dna': {'vars': 180, 'train': 1600, 'valid': 400, 'test': 1186, 'pll': 58.46},
    'kosarek': {'vars': 190, 'train': 33375, 'valid': 4450, 'test': 6675, 'pll': 10.17},
    ...
    'webkb': {'vars': 839, 'train': 2803, 'valid': 558, 'test': 838, 'pll': 155.51},
